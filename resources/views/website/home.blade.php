...
<section class="section -mt-8 relative z-20">
    <div class="container-site">
        <div class="grid gap-5 lg:grid-cols-3">
            <div class="feature-card feature-card-teal group">
                <div class="feature-icon">01</div>
                <h2 class="feature-title">{{ $isEn ? 'Fast Implementation' : 'تنفيذ سريع' }}</h2>
                <p class="feature-text">{{ $isEn ? 'Clear plan, milestones, and delivery.' : 'خطة واضحة ومراحل تنفيذ وتسليم.' }}</p>
            </div>
            <div class="feature-card feature-card-amber group">
                <div class="feature-icon">02</div>
                <h2 class="feature-title">{{ $isEn ? 'Secure Workflows' : 'سير عمل آمن' }}</h2>
                <p class="feature-text">{{ $isEn ? 'Roles, approvals, and audit trail.' : 'صلاحيات واعتمادات وسجل قرارات.' }}</p>
            </div>
            <div class="feature-card feature-card-sky group">
                <div class="feature-icon">03</div>
                <h2 class="feature-title">{{ $isEn ? 'Scalable Modules' : 'موديولات قابلة للتوسع' }}</h2>
                <p class="feature-text">{{ $isEn ? 'Add modules as your business grows.' : 'توسع بإضافة أنظمة حسب نمو شركتك.' }}</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section pt-8">
    <div class="container-site">
        ...
        <div class="mb-8 flex items-end justify-between gap-4">
            <div>
                <div class="mb-3 h-1 w-16 rounded-full bg-amber-400"></div>
                <h2 class="h2 text-slate-950">{{ $isEn ? 'Featured Services' : 'خدمات مختارة' }}</h2>
                <p class="p mt-2">
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            @forelse(($services ?? collect())->take(6) as $service)
                ...
                <a href="{{ $detailsUrl }}" class="service-card group">
